...
public class DocListener implements DocumentListener {
    	...
    	Action copy = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
    	    	try {
    				...
    				Dialogs.error("Could not copy selected text to clipboard", frame);
    	    	}
    	    }
    	};
    	...
    	Action cut = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
    	    	try {
    				...
    				Dialogs.error("Could not cut selected", frame);
    	    	}
    	    }
    	};
    	...
    	Action paste = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
    	    	try {
    				...
    				Dialogs.error("Could not paste from clipboard", frame);
    	    	}
    	    }
    	};
	...
	private void makeBinding(JTextArea area, KeyStroke key, String msg, Action act) {
